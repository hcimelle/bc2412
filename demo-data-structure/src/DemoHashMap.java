...
public class DemoHashMap {
  ...
  public static void main(String[] args) {
    ...
    // According to String.class equals(), "Apple" and "APPLE" are not equal.
    ...
    System.out.println(bookMap2); // {Book[id= 3,name= DEF]=2, Book[id= 1,name= ABC]=1, Book[id= 2,name= IJK]=1}
